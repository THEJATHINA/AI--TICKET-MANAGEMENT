...
def generate_resolution(
    ...
    # ---------------------------------------------------
    if (
        not retrieved_document
        or not retrieved_document.get("content")
    ):
    ...
    try:
        ...
        logger.exception("Groq invocation failed")
        raise RuntimeError(
    ...
    logger.info(
        f"AI resolution generated in {result['response_time']} seconds"
    )
